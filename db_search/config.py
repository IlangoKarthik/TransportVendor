...
# Data Configuration
# ==================
# DATA SOURCE: MongoDB (vendors collection)
# Flask db_search loads vendor information from MongoDB and generates its own embeddings
# Embeddings are stored in per-user local cache: data/users/{userId}/embeddings/vendor_embeddings.pkl
# 
# IMPORTANT: Node.js server manages vendor CRUD operations in MongoDB
# Flask db_search only READS vendor info and generates/caches embeddings

DATA_TYPE = "mongodb"  # DO NOT CHANGE - MongoDB is the only supported data source

# MongoDB connection configured via MONGODB_URI environment variable
# Format: mongodb://localhost:27017/netkathir_ai_tool

# Legacy database configs (kept for reference, not used)
# POSTGRESQL_CONFIG = {
...
# Option 3: MySQL Database (Uncomment to use)
# DATA_TYPE = "mysql"
# MYSQL_CONFIG = {
...
# Option 4: JSON File (Uncomment to use)
# DATA_TYPE = "json"
# DATA_PATH = os.getenv("DATA_PATH", "data/vendors.json")

# Option 5: CSV File (Uncomment to use)
# DATA_TYPE = "csv"
# DATA_PATH = "data/vendors.csv"

# Option 6: Excel File (Uncomment to use)
# DATA_TYPE = "excel"
# DATA_PATH = "data/vendors.xlsx"

EMBEDDINGS_CACHE_PATH = os.getenv("EMBEDDINGS_CACHE_PATH", "data/embeddings/cache_mongodb.pkl")

# Flask API Configuration
API_HOST = os.getenv("API_HOST", "0.0.0.0")  # 0.0.0.0 allows external connections, 127.0.0.1 for local only
API_PORT = int(os.getenv("DB_SEARCH_PORT", "5002"))
